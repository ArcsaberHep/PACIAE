        subroutine analy(nmin,nminf,ncha,nchaf,parp22)   ! 140223 Lei
...
c        i=1: y/eta window (depends on parp22)
c        i=2: pt window
c         .        .
c         .        .
c         .        .
...
c140223 Lei
c       parp22: select y or eta in partial phase-space statistics.
c               = 0 , y
c               = 1 , eta
c140223 Lei
...
c060718     c   .or.(itden.eq.1.and.ipden.eq.1))then   ! 260314
        ...
        c(1)=yy
        if( INT(parp22).eq.1 ) c(1)=eta   ! 140223 Lei
        c(2)=ppt
c       .
c       .
c       .
...
c       analyses for pp,pA and AB
        if(ipden.lt.11)
     &   call stati_h(yy,ppt,eta,p5,ik,kk,w,bn,an,bnf,anf,parp22)   ! 140223 Lei
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        subroutine stati_h(y,pt,eta,p5,ik,kk,ww,a,b,af,bf,parp22)   ! 260314 140223 Lei
...
50000   enddo
        ...
        subroutine analy_parton(parp22)
c00623 Lei2023060
c       Analyses an event based on the messages in "pyjets"
...
c           Analyses for pp,pA and AB
     ...
     &          eta, p5, kf, kk, w, bn_p, an_p, bn_p_f, an_p_f, parp22)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        subroutine stati_parton(y,pt,eta,p5,kf,kk,ww,a,b,af,bf,parp22)
c00623 Lei2023060
...
!     &'Events and Cross-sections',1X,9('*'))
 5000 FORMAT('1',8('*'),1X,'PASTAT: Statistics on Number of ',
     &'NN Events and Cross-sections',1X,8('*'))
