...
c290803
	jjj=0   
c	statistic the number of loops in parton cascade within an event
	icolo=icol   ! 120603
24      jjj=jjj+1   ! 160110   
...
c       copy parton ii to the end of 'lujets' either
...
c       modify particle list 'lujets', i. e. remove ii from 'lujets'
        if(ii.eq.n)n=n-1
        if(ii.lt.n)then
        do i1=ii+1,n
        i2=i1-1
...
c        (i. e. update particle lists: 'lujets','sbe','parlist', collis. list, 
...
c        string (i. e. update particle lists: 'lujets','sbe','parlist', 
