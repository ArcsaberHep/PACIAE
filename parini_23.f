        subroutine parini(time_ini,parp21,parp22,win,psno,ijk,mstj2,
     c   decpro,i_tune)  ! 260223 Lei2023061 added i_tune
...
c       gamt=1.
        ...
        enddo
c260223 
c       if(mstj2.eq.2.or.mstj2.eq.3)then
...
c161021 'pyjets' to 'sa2'
        ...
        enddo
c260223 
        if(mstj2.eq.2.or.mstj2.eq.3)then
        do m=1,kfmax
        numb(m)=numbs(m)
        enddo
        endif
...
c       administrate a nucleus-nucleus collision   ! 180520
     ...
     c   gamt,mstj2,decpro,i_tune)   ! 021207 260223 Lei2023061 added i_tune
        if(ijk.eq.1)return
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     c   ipau,irecon,gamt,mstj2,decpro,i_tune)   ! 021207 260223 Lei2023061 added i_tune
...
c00623
        ...
        if(mstj2.eq.2.or.mstj2.eq.3)then !! if 110123, high energy loop 260223
...
c       Executes collision event.
        call xevent(ifram,kfa,kfb,ss,pti,ptj,cctai,cctaj,i_tune)   ! 171022 Lei lei2023061 added i_tune
...
c       update collision list after calling 'pythia'
        call updtlp(time,lc,tc,tw,iii,mstj2)   ! 250423
...
c       update the collision list after ela. scattering
        call updatl(l,l1,time,lc,tc,tw,iii,mstj2)   ! 250423
...
c161222 low energy A-loop
        if(mstj2.eq.1)then    !!! if 110123, low energy A-loop 260223
...
c       update collision time list after inela. scattering
        call updatl_nn(l,l1,time,lc,tc,tw,jorn,nsa0,mstj2)   ! 250123 250423
        if(nctl.eq.0)goto 100
        goto 300
        endif  !1
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &   i_tune)   !lei2023061 added i_tune
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        subroutine updtlp(time,lc,tc,tw,iii,mstj2)   ! 250423
...
c010600
        ...
        kfi=ksa(i1,2)
        iflag=0
        call rsfilt(j1,i1,iflag,mstj2)   ! 250423
        if(iflag.eq.0)goto 100
        tc(nctl)=0.0
c011204 call tcolij(i1,j1,time,nctl,lc,tc,tw,mstj2)   ! 250423
        call tcolij(j1,i1,time,nctl,lc,tc,tw,mstj2)   ! 250423
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        subroutine rsfilt(l,l1,iflag,mstj2)   ! 250423
...
c        and intdis
     ...
     c   disbe(100,100)
        ...
        if(mstj2.eq.2.or.mstj2.eq.3)then   ! high energy loops (B and C) 250423
...
c250423
        if(mstj2.eq.1)then    ! low energy loop A
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        subroutine tcolij(l,l1,time,icp,lc,tc,tw,mstj2)   ! 250423
c       calculate collision time & fill up lc(i,1-2) as well as tc(i) 
        IMPLICIT DOUBLE PRECISION(A-H, O-Z)
        IMPLICIT INTEGER(I-N)
        INTEGER PYK,PYCHGE,PYCOMP
...
20      call intdis(l,l1,ss,rsig,mstj2)   ! 250423
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        subroutine intdis(l,l1,ss,rsig,mstj2)   ! 250423
...
c250423 ss: square root s_NN
     ...
     c   ,rnt,rnp,rao,rou0,vneu,vneum,ecsspn,ecsspm,ecsen   ! 060813
        ...
        if(mstj2.eq.2.or.mstj2.eq.3)then      ! 250423
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        subroutine updatl(ic,jc,time,lc,tc,tw,iii,mstj2)   ! 250423
...
c       forbiden scattered particles colliding with each other
        ...
        if(iflag.eq.0)goto 100
        tc(nctl)=0.0
        call tcolij(i1,j1,time,nctl,lc,tc,tw,mstj2)   ! 250423
        if(tc(nctl).gt.1.0e-7) nctl=nctl+1
100     continue
600     enddo
...
c        to Lab or cms frame of nucleus-nucleus collision system
        ...
        call updatl_nn(l,l1,time,lc,tc,tw,3,nsa0,mstj2)   ! 250423
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        subroutine updatl_nn(ic,jc,time,lc,tc,tw,ik,nsa0,mstj2) ! 250423
