...
c     c	 parj(45)
        write(9,*)'parecc,iparres=',parecc,iparres   ! 220312 240412
	if(iflmax.ne.0)then
	do kk=1,ispmax
	do i=1,iflmax
...
840	call stati(yy,ppt,eta,p5,ik,kk,w,bn,an,bnf,anf)   ! 010600
        call flow_f(p1,p2,ppt,yy,eta,p5,ik,kk)   ! 220607 010412
