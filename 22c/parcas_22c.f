...
c020512	       if(lmn.ne.4 .or. lmn.ne.6 .or. lmn.ne.7)
c020512	    c  call update_ctl(tcp,iway)   ! 120505 160110
c020512 update collis. list for both els. and inela. parton-paron interaction
        call update_ctl(tcp,iway)   ! 020512
c120505
c	'new' method
...
c020512 update the collision time list for both ela. and inela.
